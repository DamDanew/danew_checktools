...
- [x] Phase 2: generer le HTML complet seulement sur demande explicite (analyse complete ou action ouvrir rapport detaille).
- [x] Phase 3: produire un resume SAV immediat avant les artefacts lourds.
- [x] Phase 4: ajouter un cache incremental EVTX base sur chemin/taille/date de modification.
- [x] Phase 5: ne lancer exports cibles/ZIP que sur action explicite, jamais par defaut au premier diagnostic.
