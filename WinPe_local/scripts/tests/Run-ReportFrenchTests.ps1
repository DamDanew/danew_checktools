...
try {
    ...
    $results += Add-ReportFrenchResult -Name 'launcher_buttons_localized' -Passed ($launcherSource -match 'ANALYSE RAPIDE' -and $launcherSource -match 'ANALYSE COMPLETE' -and $launcherSource -match 'ANALYSER CAUSES' -and $launcherSource -match 'OUVRIR LE RAPPORT SAV' -and $launcherSource -match 'OUVRIR LE DOSSIER DES RAPPORTS' -and ($launcherSource -match 'VERIFIER WINPE' -or $launcherSource -match 'VÉRIFIER WINPE')) -Details 'launcher visible buttons localized'
